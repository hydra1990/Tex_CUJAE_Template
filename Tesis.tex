...
\input{Configuraciones/Administrativo.tex}
...
%Márgenes
\input{Configuraciones/Margenes.tex}
...
\input{Paginas_Princ/Fijo/Titulo}

\input{Paginas_Princ/Pensamiento}

\input{Paginas_Princ/Agradecimientos.tex}

\input{Paginas_Princ/Dedicatoria.tex}

\input{Paginas_Princ/Resumen}

\input{Paginas_Princ/Abstract}

\input{Paginas_Princ/Fijo/TablaDeContenidos.tex}

\input{Paginas_Princ/Fijo/ListaDeFiguras.tex}

\input{Paginas_Princ/Fijo/ListaDeTablas.tex}
...
\input{Capitulos/Introduccion} % Introducción
...
%% Conclusiones ---------------------------------------------------
\input{Paginas_Princ/Conclusiones.tex}

%% Recomendaciones ---------------------------------------------------
\input{Paginas_Princ/Recomendaciones.tex}
...
\input{Paginas_Princ/Glosario.tex}
